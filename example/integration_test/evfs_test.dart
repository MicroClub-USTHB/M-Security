...
void main() {
  ...
  group('EVFS', () {
    ...
    test('defragment compacts free space', () async {
      ...
      // Data still readable
      expect((await VaultService.read(handle: handle, name: 'a.txt')).data, dataA);
      expect((await VaultService.read(handle: handle, name: 'c.txt')).data, dataC);
    ...
    test('resize shrink after defrag', () async {
      ...
      // Data still readable
      expect((await VaultService.read(handle: handle, name: 'small.bin')).data, data);
