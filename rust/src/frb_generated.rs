...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 932968050;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        19 => wire__crate__api__hashing__hasher_finalize_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__hashing__hasher_reset_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__hashing__hasher_update_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__kdf__hkdf__hkdf_expand_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__encryption__noop__noop_encryption_algorithm_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        26 => wire__crate__api__encryption__noop__noop_encryption_decrypt_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        27 => wire__crate__api__encryption__noop__noop_encryption_encrypt_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        22 => wire__crate__api__kdf__hkdf__hkdf_derive_impl(ptr, rust_vec_len, data_len),
        24 => wire__crate__api__kdf__hkdf__hkdf_extract_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
