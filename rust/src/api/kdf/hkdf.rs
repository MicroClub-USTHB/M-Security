...
#[frb(sync)]
pub fn hkdf_extract(mut ikm: Vec<u8>, mut salt: Option<Vec<u8>>) -> Result<Vec<u8>, CryptoError> {
    let salt_ref = salt.as_ref().map(Vec::as_slice);
...
mod tests {
    ...
    fn rfc5869_test_case_2() {
        ...
        let salt = Some(hex("606162636465666768696a6b6c6d6e6f\
        ...
        let expected = hex("b11e398dc80327a1c8e7f78c596a4934\
    ...
    fn rfc5869_test_case_3() {
        let ikm = hex("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b");
        let info = vec![];
        let expected = hex("8da4e775a563c18f715f802a063c5a31\
